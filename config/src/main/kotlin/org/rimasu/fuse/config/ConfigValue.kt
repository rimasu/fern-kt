...
sealed class ConfigValue {
    ...
    /**
     * Get the value as a string. Will return an
     * error if the value can not be coerced into a
     * string.
     */
    abstract fun asString(): Result<String, ConfigError>

    /**
     * Get the value as an integer. Will return an
     * error if the value can not be coerced into a
     * string.
     */
    ...
    /**
     * Get the value as config. Will return
     * a error if the value can be coerced into a
     * config.
     */
